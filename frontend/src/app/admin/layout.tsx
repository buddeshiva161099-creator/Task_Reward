...
import {
  ...
  Settings, Calendar, Clock, DollarSign, Trash2, MessageSquare, Briefcase, Megaphone, Palette, Flame
} from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/admin/shifts', label: 'Shifts & Rosters', icon: Clock, visible: isHRTeam },
    ...
    { href: '/admin/fatigue', label: 'Fatigue & Attrition', icon: Flame, visible: isManagementRole },
    ...
    <div className="min-h-screen bg-background flex">
      ...
      `}>
        ...
        <div className="p-5 border-b border-border flex items-center justify-between">
          ...
          <button 
            onClick={() => setIsMobileMenuOpen(false)}
            className="p-1.5 hover:bg-slate-100 rounded-lg lg:hidden text-slate-500 transition-colors"
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 mb-3">
            {user.profile_picture ? (
              <img src={user.profile_picture} alt="Profile" className="w-9 h-9 rounded-full object-cover border border-slate-200" />
            ) : (
      ...
      <main className="flex-1 lg:ml-64 min-h-screen flex flex-col">
              ...
              <div className="absolute right-0 top-full pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                <div className="bg-white border border-slate-200 rounded-xl shadow-xl p-2 w-48">
                  ...
                  <button 
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg text-xs font-bold text-slate-600 transition-colors"
                  >
                    <div className="w-6 h-6 rounded-lg bg-indigo-50 flex items-center justify-center">
        ...
        <div
          className="p-6 lg:p-8 max-w-[1600px] mx-auto w-full flex-1"
