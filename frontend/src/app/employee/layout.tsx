...
import {
  LayoutDashboard, ClipboardList, LogOut, Zap, ChevronRight, Trophy, MapPin, Menu, BarChart, Calendar, Clock, DollarSign, MessageSquare, Megaphone, Palette, X as CloseIcon
} from 'lucide-react';
